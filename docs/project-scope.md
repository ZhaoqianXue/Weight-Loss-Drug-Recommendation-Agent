...
Detailed changed-file lists and execution checks are preserved in the [original scope snapshot](../archive/project-history/history/execution-records.md#original-13) and the [eight-brand execution history](../archive/project-history/history/execution-records.md#eight-brand-scope-change). They are historical implementation records, not additional scope requirements.
