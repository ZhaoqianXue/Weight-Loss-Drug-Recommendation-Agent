...
Reorganized on 2026-09-14. Observations and counts below were recorded on 2026-09-12, not remeasured during this documentation task. Earlier wording, with a subsequent editorial update noted, is retained in the [execution archive](../archive/project-history/history/execution-records.md#original-12).

## Confirmed project decisions

- Use WebMD and Reddit; retain four molecules and eight brands, with exclusions governed by [project scope](project-scope.md).
