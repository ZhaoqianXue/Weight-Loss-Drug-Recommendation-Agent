...
class SnapshotTests(unittest.TestCase):
    ...
    def test_all_current_outputs_share_ids_and_provenance(self):
        ...
        for name in ('data/interim/migrated-2026-09-14/extracted_reviews_all.csv','data/processed/migrated-2026-09-14/standardized_reviews_all.csv','results/migrated-2026-09-14/demo/static/standardized_reviews_all.csv','results/migrated-2026-09-14/demo/static/standardized_reviews_all.csv'):
        ...
        for name in ('results/migrated-2026-09-14/demo/static/standardized_reviews_all.csv','results/migrated-2026-09-14/demo/static/standardized_reviews_all.csv'):
